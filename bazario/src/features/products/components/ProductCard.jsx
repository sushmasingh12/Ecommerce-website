  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-3/4 overflow-hidden bg-gray-50">
        ...
        <img
          className={`w-full h-full object-contain transition-transform duration-500 group-hover:scale-105 ${!product.inStock ? "opacity-50" : ""}`}
        ...
        <button
          ...
          className={`absolute top-2 right-2 w-8 h-8 rounded-full flex items-center justify-center transition-all shadow-sm ${
            loved
              ...
              : "bg-white text-gray-400 hover:text-[tertiary]"
          }`}
        >
          <span
            className="material-symbols-outlined text-base"
            style={{ fontVariationSettings: loved ? "'FILL' 1" : "'FILL' 0" }}
          >
            favorite
          </span>
        </button>
      ...
      {/* Info */}
      <div className="p-3">
        <h4 className="text-sm font-medium text-gray-800 leading-tight line-clamp-2 mb-1.5">
          {product.name}
        </h4>
        ...
        {/* Free delivery tag */}
        <p className="text-[10px] text-[#00A651] font-medium mt-1">
          ✓ Free Delivery
        </p>
